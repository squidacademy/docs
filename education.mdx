...
Unlike institutional accreditation bodies that assess an organisation as a whole, EAF evaluates the quality of the educational product itself.
...
EAF accreditation provides assurance that a program has been evaluated against recognised educational standards and learning science principles.
...
- Educational experiences are learner-centred.
...
The accreditation demonstrates that the program has been assessed against internationally recognised educational quality standards.
...
This layer ensures that students are engaging with learning experiences that have been independently evaluated against recognised educational standards.
