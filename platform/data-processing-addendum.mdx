...
c) **Sub‑processor list & notice.** Squid will maintain a current [<u>Sub‑processor List</u>](/platform/sub-processor-list) and provide at least 30 days’ advance notice of any new or replacement sub‑processor by (i) emailing the Organization’s admin contact(s) and (ii) updating the Sub‑processor List. Where an emergency replacement is required to maintain availability, security, or support, Squid may appoint the sub‑processor and will provide notice without undue delay, after which the Organization may raise a reasonable objection; if unresolved in good faith within a reasonable period, either party may terminate only the affected Service for a pro‑rated refund.
